class Config():
    def __init__(
        ...
        vocab_size,
        CUDA = 0,
        name = "traj_w_all_Model_finetune_dest",
        ...
        pad_token_id=1,
        del_tasks="position", # dest or position
        ...
        resume = True,
        path_state = "traj_rnnbased_wo_dest_num_hid_layer_2_e4.pt",
        # traj_rnnbased_wo_dest_num_hid_layer_2_e4.pt : all
        # traj_rnnbased_wo_perm_mapemb_aug_dest_num_hid_layer_2_e4.pt : mask
        # traj_w_mapemb_num_hid_layer_2_e4.pt : mapemb
        # traj_w_aug_num_hid_layer_2_e4.pt : aug
        # traj_wo_dest_mapemb_aug_mask_num_hid_layer_2_e3 : perm
